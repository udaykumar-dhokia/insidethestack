...
<img
  src="/slack.png"
  alt="Slack architecture diagram showing Channel Servers, Gateway Servers, and WebSocket connections"
  title="How Slack's real-time messaging architecture works"
  loading="lazy"
/>
